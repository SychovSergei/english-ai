import { CreateWordSetDto, UpdateWordSetDto } from 'app-old/core/domain/entities/word-set/types/create-word-set.dto';
import { IValidationService, IWordSetService } from 'app-old/core/interfaces';
import { createWordSetDtoSchema } from 'app-old/infrastructure/http/dtos';
