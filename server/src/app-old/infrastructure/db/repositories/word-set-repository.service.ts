...
import { UpdateWordDto } from 'app-old/core/domain/entities/word/types/word.dto';
...
import { WordSetModel } from 'app-old/infrastructure/db/entities';
import { WordSetMapper } from 'app-old/application/mappers/word-set.mapper';
