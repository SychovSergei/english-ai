...
@Component({
  ...
  standalone: true,
  imports: [UiKitModule, ReactiveFormsModule, RouterLink, ErrorMessageModule, NgIf, CustomSpinnerDirective],
})
export class LoginComponent implements OnInit {
  private readonly sessionFacade = inject(SessionFacade);
  // UI-состояние (Loading, Error) можно держать в сигнале или компоненте
